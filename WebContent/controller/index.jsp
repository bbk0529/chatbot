...
<div class="container">
	...
	<div class="row" style="background-image:url('../resources/img/banner.jpg');">
			<div class="col-sm-1" style="background-color:rgba(70,70,70,0.7);height:400px"></div>
			<div class="col-sm-1" style="background-color:rgba(80,80,80,0.7);height:400px"></div>
			<div id="chatList" class="col-sm-10" style="background-color:rgba(100,100,100,0.7);height:400px;overflow:auto;);"></div>
